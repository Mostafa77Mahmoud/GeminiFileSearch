...
2. لكل بند مهم، حدد:
   ...
   - potential_issues: قائمة بكلمات مفتاحية شرعية محتملة (مثل "gharar" للجهالة، "riba" للفائدة، "ta'wid" للتعويض، "zulm" للظلم، "istisna'" للاستصناع، "jahala" للجهالة، "shurut" للشروط، "tahkim" للتحكيم). استخدم مصطلحات من AAOIFI لتعزيز الصلة.
   - relevance_reason: شرح مختصر لماذا هذا البند مهم شرعياً (مثل "قد يحتوي على غرر بسبب عدم إبداء أسباب").
...
[
  {{
    ...
    "potential_issues": ["gharar", "riba", "ta'wid"],
